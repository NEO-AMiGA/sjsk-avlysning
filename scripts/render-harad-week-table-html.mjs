...
function buildStyles() {
  return [
    ...
    '    .weektable .time{text-align:center;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}',
    '    .weektable .col-week{width:40px}',
    '    .weektable .col-time{min-width:92px}',
    '    .weektable .col-danger{min-width:92px}',
    ...
    '    <table class="weektable">',
      '      <thead>',
        '        <tr>',
          ...
          '          <th class="center col-focus col-danger">Risk över<br>banor</th>',
